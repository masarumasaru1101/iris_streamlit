...
# DataFrameの初期化
value_df = pd.DataFrame(columns=['feature1', 'feature2', 'feature3', 'feature4', 'target'])

# recordをPandas Seriesに変換
record_series = pd.Series(record, index=value_df.columns)

# DataFrameに行を追加
value_df = value_df.append(record_series, ignore_index=True)